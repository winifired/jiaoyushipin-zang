...
function share(img, name, des) {
    console.log(img, name, des)
    wx.ready(function () {
        wx.checkJsApi({
...
export function getwxConfig(coverImg = 'http://jiaoyushipin.winderinfo.com/jysp/profile/upload/2021/11/18/9f48cc3c-dddb-4215-a7eb-532213961105.jpg', title) {
