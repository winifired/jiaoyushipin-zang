  ...
  <div>
    <div class="fixedtop">
      ...
      <van-dropdown-menu class="dropdown-meau" active-color="#FFA000">
        <van-dropdown-item class="dropdown-item" @open="openMeau(1)" ref="item" @close="closeMeau">
          <template #title>
            <p class="f28 flex row-center">
              <span>{{$t('kechengxingshi')}}</span>
              <img src="../assets/up-icon.png" alt class="icon32 marginL" v-if="activeMeau != 1" />
              <img src="../assets/down-icon.png" alt class="icon32 marginL" v-if="activeMeau == 1" />
            </p>
          </template>
          <div
          ...
          <template #title>
            <p class="f28 flex row-center">
              ...
              <img
                ...
                v-if="activeMeau != 2"
              />
              <img src="../assets/down-icon.png" alt class="icon32 marginL" v-if="activeMeau == 2" />
            </p>
          </template>
          <div
            class="flex area-between meau-item"
